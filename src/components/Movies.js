...
function Movies () {
  ...
  const movies  =  streamData.entries.filter ( entry => entry.programType === 'movie' && entry.releaseYear >= 2010 ) 
                        ...
                        {movies.map((movie) =>
                            <div className='col-lg-3 p-3 col-sm-12'>
                                <div className="card">
                                  ...
                                  <img src={movie.images["Poster Art"].url} className='card-img-top' alt='place' />
                                  <div class="card-body">
